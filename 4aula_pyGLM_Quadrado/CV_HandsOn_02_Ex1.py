...
class VCHelper:
    ...
    def compute_proj_view_matrix(self):
        ...
        # this will locate the uniform named "projection" and store the
        # corresponding matrix. Note that the glUniformMatrix4fv function
        # expects a matrix as a flat array of floats. And it expects a 
        # column-major representation. The first requirement is solved by 
        # np.array; the second by the GL_TRUE that transposes the matrix
    ...
    def compute_transf_matrix_triangle(self):
        ...
        modelMatrix_triangle, glm.vec3(self.tx, self.ty, self.tz))
